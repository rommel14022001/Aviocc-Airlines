...
class HashTable():
    ...
    def insertarEnIndices(self, avion):
        self.indicesNombres.append({'name': avion.name, 'serial': avion.serial})

        self.indicesModelo.append({'modelo': avion.modelo, 'serial': avion.serial})
    ...
    def eliminarEnIndices(self, avion):
        ...
        self.indicesNombres.pop(self.busquedaPorNombre(avion.nombre))
